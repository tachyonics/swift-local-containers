// Temporarily commented out to isolate _recursivelyApplyTraits crash on Linux.
// This is the only test that uses ContainerTrait (TestScoping) as a @Suite trait.
// See MinimalTraitTests in PlatformRuntimeTests for the reproducer.
